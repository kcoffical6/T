...
export const bookingsApi = {
  ...
  rejectBooking: (id: string, reason: string) =>
    api.post(`/admin/bookings/${id}/reject`, { reason }).then(res => res.data),
...
export const vehiclesApi = {
  ...
  toggleAvailability: (id: string) =>
    api.patch(`/admin/vehicles/${id}/availability-toggle`).then(res => res.data),
...
export const reportsApi = {
  ...
  exportBookings: (params?: any) =>
    api.get('/admin/reports/export/bookings', { params, responseType: 'blob' }).then(res => res.data),
}
